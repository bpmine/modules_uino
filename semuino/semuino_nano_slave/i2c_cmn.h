/**
 * @file i2c_cmn.h
 * @brief Interface commune entre le ma�tre et l'esclave I�C
*/
...
#define REG_CTRL        (1)       ///< Id du registre de contr�le
#define REG_LEVEL       (2)       ///< Id du registre contenant le niveau d'�clairage
